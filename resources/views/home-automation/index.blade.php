    ...
    <div class="row">
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <div class="about_text wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.5s">
          ...
          <a href="{{route('home_aboutUs')}}" class="btn"> Read More</a> <img src="{{asset('home/images/lox.jpg')}}" class="img-responsive pull-Left" alt="">  </div>
      </div>
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <div class="about_img wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.5s"> 
          <img src="{{asset($cms_home1->image)}}" class="img-responsive" alt=""> </div>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
        <div class="white_box wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
          <div class="row">
            ...
            @endforeach
            <!-- <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
              <div class="what_div"> <img src="{{asset('home/images/ww_3.jpg')}}" alt="">
                <h4>Programming </h4>
                <div class="green_line"></div>
            ...
            <!-- <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
              <div class="what_div"> <img src="{{asset('home/images/ww_4.jpg')}}" alt="">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="blogslid">
            ...
            @endforeach
            <!-- <div>
              <div class="main_pj"><img src="{{asset('home/images/pj_1.jpg')}}" class="img-responsive" alt=""></div>
            </div> -->
            <!-- <div>
              <div class="main_pj"><img src="{{asset('home/images/pj_1.jpg')}}" class="img-responsive" alt=""></div>
            </div> -->
