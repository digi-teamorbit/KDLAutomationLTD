    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="main_heading text-center">
          ...
          <div class="loxon"><img src="{{asset('home/images/lox.png')}}" class="img-responsive" alt=""></div>
        </div>
      </div>
    </div>
    <div class="pj_bg">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="blogslid">
            <div>
              <div class="main_pj"><img src="{{asset('home/images/lx_1.jpg')}}" class="img-responsive" alt=""></div>
            </div>
            <div>
              <div class="main_pj"><img src="{{asset('home/images/lx_1.jpg')}}" class="img-responsive" alt=""></div>
            </div>
