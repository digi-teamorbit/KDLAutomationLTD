          ...
          <div class="col-md-4 col-sm-4">
            <div class="row">
              <div class="contact-info">
                <div class="col-md-3">
                  <div class="cicle-icon">
                    <img src="{{asset('home/images/location-icon.png')}}" class="img-responsive" alt="">
                  </div>
                </div>
                <div class="col-md-9">
              ...
              <div class="contact-info">
                <div class="col-md-3">
                  <div class="cicle-icon">
                    <img src="{{asset('home/images/phone.png')}}" class="img-responsive" alt="">
                  </div>
                </div>
                <div class="col-md-9">
                  <div class="contact_text">
              ...
              <div class="contact-info">
                <div class="col-md-3">
                  <div class="cicle-icon">
                    <img src="{{asset('home/images/email-icon.png')}}" class="img-responsive" alt="">
                  </div>
                </div>
                <div class="col-md-9">
                  <div class="contact_text">
