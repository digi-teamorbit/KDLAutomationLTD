          ...
          <div class="card-body">
           ...
           <div class="clearfix"></div>
            ...
            <div class="col-lg-4 col-md-4">
                <img alt="" id="input-preview" src="{{ isset($logo)?asset($logo->img_path):asset('images/upload.jpg') }}" style="width: 100%; background-color: grey;">
            ...
            <div class="col-lg-4 col-md-4">
                <img alt="" id="input-preview" src="{{ isset($logo1)?asset($logo1->img_path):asset('images/upload.jpg') }}" style="width: 100%; background-color: grey;">
        <div class="upload-photo">
