                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex m-b-10 no-block">
                            <h5 class="card-title m-b-0 align-self-center">Airport Contact Submissions</h5>
                        ...
                        <div class="table-responsive m-t-10">
                            <table id="myTable" class="table color-table table-bordered product-table table-hover dataTable no-footer" role="grid" aria-describedby="myTable_info" >
                                ...
                                <tbody>
								@foreach($contact_inquiries2 as $item)	
									<tr>
									  <td>{{ $item->id }}</td>
										...
										<td class="">
                                            ...
                                            <a href="{{ url('/admin/contact/airport_inquiries/'.$item->id) }}"
                                               title="View Language">
                                            ...
                                            <a href="{{ url('/admin/contact/airport_submissions/delete',$item->id) }}"
                                               title="View Language">
