            ...
            <nav class="sidebar-nav ">
                <ul id="sidebarnav">
                    <li class="clearfix"></li>
                        ...
                        <li class=""><a class="has-arrow waves-effect waves-dark" href="{{url('dashboard')}}" aria-expanded="false"><i class="flaticon-desktop-computer-screen-with-rising-graph"></i>
                            <span class="hide-menu">Airport</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('admin/airport-banner')}}" class="">Banner Management</a></li>
                                <li><a href="{{url('admin/airport-inner-banner')}}" class="">Inner Banner</a></li>
                                <li><a href="{{ url('admin/airport-pages') }}" class="">Pages Content</a></li>
                                <li><a href="{{ url('admin/airport-project') }}" class="">Projects</a></li>
                                <li><a href="{{ url('admin/what-we-do-airport') }}" class="">What We Do</a></li>
                                <li><a href="{{url('admin/contact/airport_inquiries')}}" class="">Contact Inquiries</a></li>
                            </ul>
                        </li>
                        ...
                        <li class=""><a class="has-arrow waves-effect waves-dark" href="{{url('dashboard')}}" aria-expanded="false"><i class="flaticon-desktop-computer-screen-with-rising-graph"></i>
                            <span class="hide-menu">Home Automation</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('admin/home-banner')}}" class="">Banner Management</a></li>
                                <li><a href="{{url('admin/home-inner-banner')}}" class="">Inner Banner</a></li>
                                <li><a href="{{ url('admin/page') }}" class="">Pages Content</a></li>
                                <li><a href="{{ url('admin/home-project') }}" class="">Projects</a></li>
                                <li><a href="{{ url('admin/what-we-do-home') }}" class="">What We Do</a></li>
